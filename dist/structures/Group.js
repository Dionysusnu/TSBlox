(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Base", "./Collection", "./User", "./Role", "./GroupMember", "./Shout"], factory);
    }
    ...
    class Group extends Base_1.Base {
        constructor(client, data) {
             ...
             */
            this.owner = this.member(this.client.users.get(data.owner.userId) || new User_1.User(client, data.owner));
            /**
        ...
        update(data) {
            ...
            this.owner = this.member(this.client.users.get(data.owner.userId) || new User_1.User(this.client, data.owner));
