...
class Client extends events_1.default {
    ...
    async getGroup(id) {
        ...
        return new Structures_1.Group(this, response.data);
    }
    async getUser(id) {
        ...
        return new Structures_1.User(this, response.data);
    }
}
