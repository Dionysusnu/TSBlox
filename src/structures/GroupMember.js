 ...
 */
class GroupMember extends Structures_1.Base {
    constructor(client, data, group) {
        const user = new Structures_1.User(client, data.user);
         ...
         */
        this.role = group.roles.get(data.role.id) || new Structures_1.Role(client, data.role, group);
    }
    /**
